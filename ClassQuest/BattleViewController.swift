...
class BattleViewController: UIViewController {
    ...
    func transition(){
        ...
        let viewController = storyboard.instantiateViewController(withIdentifier: "QuestViewController") as! QuestViewController
    ...
    func showPopup(){
        let popOverVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "QuestionPopUp") as! PopUpViewController
