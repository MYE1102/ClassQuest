...
class DestinationViewController: UIViewController {
    ...
    func showPopup(){
        let popOverVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ArriveTherePopUp") as! PopUpViewController
    ...
    func transition(){
        ...
        let viewController = storyboard.instantiateViewController(withIdentifier: "BattleViewController") as! BattleViewController
